    ...
    return (
      <div className="py-10 md:py-44 mx-10">
        <div className="container mx-auto max-w-5xl bg-gray-900 py-10 px-5 rounded-xl shadow-md text-center">
          <img className="w-full rounded-lg transition delay-150 duration-300 ease-in-out hover:scale-105" src={project.img} alt={project.title} />
          ...
          <a href={project.link} className="text-gray-600 hover:text-gray-300 hover:underline">{project.link}</a>
