    ...
    <div className="py-10 md:py-44 mx-10">
      <div className="container mx-auto max-w-2xl bg-gray-900 py-10 px-5 rounded-xl shadow-md">
        ...
        <div className="flex space-x-2">
          <a
            href="/project"
            className="text-md font-semibold no-underline hover:underline"
          >
            View All Projects{" "}
          </a>
          <MdArrowOutward />
        ...
        <div className="py-10 md:py-10">
          ...
          <div className="flex space-x-5 text-xl text-slate-400">
            <a target="_blank" href="mailto:makdeesirawit@gmail.com">
              <MdOutlineMail />{" "}
            </a>
      ...
      <button
        className="rounded-full bg-gray-900 text-white p-4 fixed bottom-5 right-5"
        onClick={scrollToTop}
      >
        <FaAngleDoubleUp />
      </button>
